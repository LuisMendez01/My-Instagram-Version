...
@IBDesignable open class RSKPlaceholderTextView: UITextView {
    ...
    private var placeholderAttributes: [NSAttributedString.Key: Any] {
        ...
        if placeholderAttributes[NSAttributedString.Key.font] == nil {
            ...
            placeholderAttributes[NSAttributedString.Key.font] = self.typingAttributes[NSAttributedString.Key.font] ??
    ...
    open override func draw(_ rect: CGRect) {
        ...
        let placeholderRect = rect.inset(by: self.placeholderInsets)//This will go in placeholderInserts go UIEdgeInsets(top: 0, left: 8, bottom: 0, right: 8))
